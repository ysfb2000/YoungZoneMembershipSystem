...
namespace YzMember
{
    public partial class AddPointRePrintForm : Form
    {
        string TempCardNo, TempYPoint, TempNowPoint, TempVpoint, TempName,TempTime;

        public AddPointRePrintForm(string strmessage,string CardNo,string YPoint,string NowPoint,string Vpoint,string Name,string Time)
        {
            InitializeComponent();
